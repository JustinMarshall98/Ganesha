...
class PolygonAddWindow(wx.Frame):
    def __init__(self, parent, ID, title):
        ...
        sizer_sections.Add(
            sizer_options, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        # Buttons
        ...
        sizer_sections.Add(
            sizer_buttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
...
class PolygonEditWindow(wx.Frame):
    def __init__(self, parent, ID, title):
        ...
        for i, data in enumerate(
            ...
            if (
                data == "copyVector"
                or data == "pasteVector"
                or data == "copyLighting"
                or data == "pasteLighting"
                or data == "copyUV"
                or data == "pasteUV"
            ):
            ...
            if data == "X":
                ...
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 0, "-28", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move)
                sizer_point_table.Add(button)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 0, "-1", size=wx.Size(50, -1)
                )
                ...
                sizer_point_table.Add(data_label)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 2, "-12", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move)
                sizer_point_table.Add(button)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 2, "-1", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move_small)
            elif data == "Z":
                ...
                sizer_point_table.Add(data_label)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 4, "-28", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move)
                sizer_point_table.Add(button)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 4, "-1", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move_small)
                ...
                sizer_point_table.Add(data_label)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 6, "-20", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move)
                sizer_point_table.Add(button)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 6, "-1", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move_small)
            elif data == "V":
                ...
                sizer_point_table.Add(data_label)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 8, "-20", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move)
                sizer_point_table.Add(button)
                button = wx.Button(
                    panel, POLYGON_MOVE_ID + 8, "-1", size=wx.Size(50, -1)
                )
                button.Bind(wx.EVT_BUTTON, self.on_move_small)
            else:
                sizer_point_table.Add(data_label)
            ...
            if (
                data != "copyVector"
                and data != "pasteVector"
                and data != "copyLighting"
                and data != "pasteLighting"
                and data != "copyUV"
                and data != "pasteUV"
            ):
                ...
                if data == "X":
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 1, "+1", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move_small)
                    sizer_point_table.Add(button)
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 1, "+28", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move)
                elif data == "Y":
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 3, "+1", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move_small)
                    sizer_point_table.Add(button)
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 3, "+12", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move)
                elif data == "Z":
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 5, "+1", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move_small)
                    sizer_point_table.Add(button)
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 5, "+28", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move)
                elif data == "U":
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 7, "+1", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move_small)
                    sizer_point_table.Add(button)
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 7, "+20", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move)
                elif data == "V":
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 9, "+1", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move_small)
                    sizer_point_table.Add(button)
                    button = wx.Button(
                        panel, POLYGON_MOVE_ID + 9, "+20", size=wx.Size(50, -1)
                    )
                    button.Bind(wx.EVT_BUTTON, self.on_move)
                else:
                    button = wx.StaticText(panel, wx.ID_ANY, "")
        ...
        sizer_sections.Add(
            sizer_rotate_buttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        ...
        # add horizontal box to whole list
        sizer_sections.Add(
            sizer_rotate_colbuttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        ...
        # add horizontal box to whole list
        sizer_sections.Add(
            sizer_rotate_xybuttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        ...
        # add horizontal box to whole list
        sizer_sections.Add(
            sizer_rotate_zybuttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        ...
        sizer_sections.Add(
            sizer_mid_buttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        ...
        sizer_sections.Add(
            texture_terrain_sizer, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        # Visibility Angles
    ...
    def on_delete(self, event):
        sure = wx.MessageDialog(
            self, "Are you sure?", style=wx.YES_NO | wx.NO_DEFAULT | wx.ICON_QUESTION
        )
    ...
    def from_data(self, polygon):
        ...
        for pt in ["A", "B", "C", "D"]:
            if (
                not hasattr(polygon.source, pt)
                or getattr(polygon.source, pt).normal is None
            ):
        ...
        if polygon.source.terrain_coords is not None:
            ...
            if (
                polygon.source.terrain_coords[0] == 255
                and polygon.source.terrain_coords[1] == 127
            ):
        ...
        for bit, label in visibility_bits:
            if bit is not None:
                self.inputs[("visibility", bit)].SetValue(
                    bool(polygon.source.visible_angles[bit])
                )
            ...
            if poly_difference < 100:
                if len(new_list) > len(self.polygon_list):
                    for index in range(poly_difference):
                        self.inputs["polygon_selector_box"].Append(
                            "Polygon_" + str(len(self.polygon_list) + index)
                        )
                else:
                    for index in range(poly_difference):
    ...
    def to_data(self, foo):
        ...
        if self.app.selected_object.source.texture_page is not None:
            self.app.selected_object.source.texture_page = int(
                self.inputs["page"].GetValue()
            )
        if self.app.selected_object.source.texture_palette is not None:
            self.app.selected_object.source.texture_palette = int(
                self.inputs["palette"].GetValue()
            )
        if self.app.selected_object.source.terrain_coords is not None:
            if self.inputs["tX"].GetValue() == "" or self.inputs["tZ"].GetValue() == "":
                ...
                terrain_coords = (
                    int(self.inputs["tX"].GetValue()),
                    int(self.inputs["tZ"].GetValue()),
                    int(self.inputs["tlvl"].GetValue()),
                )
            self.app.selected_object.source.terrain_coords = terrain_coords
        for bit, label in visibility_bits:
            if bit is not None:
                self.app.selected_object.source.visible_angles[bit] = (
                    1 if self.inputs[("visibility", bit)].GetValue() else 0
                )
...
class UVEditWindow(DirectObject):
    ...
    def open(self):
        ...
        self.uv_window = base.graphicsEngine.makeOutput(
            base.pipe, "UV Coordinates", 2, fp, wp, GraphicsPipe.BFRequireWindow
        )
    ...
    def draw_texture(self):
        ...
        for page in range(4):
            ...
            vdata = GeomVertexData(
                "texture_page_%u" % page, GeomVertexFormat.getV3c4t2(), Geom.UHStatic
            )
...
class TerrainDimensionsEditWindow(wx.Frame):
    ...
    def on_ok(self, event):
        ...
        if new_x == 0 or new_z == 0:
            print(
                "Terrain Dimension Warning: X and Z can't be equal to 0 (nonexistant size)."
            )
        elif new_x == 256 or new_z == 256:
            print(
                "Terrain Dimension Warning: X and Z can't be equal to 256 (ubyte range 0-255)."
            )
        elif new_x * new_z > 256:
            print(
                "Terrain Dimension Warning: (X*Z) cannot be greater than 256. (256 tile maximum for maps)"
            )
        else:
...
class TerrainEditWindow(wx.Frame):
    def __init__(self, parent, ID, title):
        ...
        sizer_main_table.Add(label)
        data_input = wx.Choice(
            panel, TERRAIN_INPUT_ID + 9, choices=list(surface_types.values())
        )
        sizer_main_table.Add(data_input)
        self.inputs[(0, "surface_type")] = data_input
        data_input = wx.Choice(
            panel, TERRAIN_INPUT_ID + 10, choices=list(surface_types.values())
        )
        sizer_main_table.Add(data_input)
    ...
    def to_data(self, foo):
        ...
        for i, tile in enumerate(tiles):
            ...
            tile.slope_type = slope_types[
                self.inputs[(i, "slope_type")].GetCurrentSelection()
            ][0]
    ...
    def to_data(self, foo):
        for tile in self.app.selected_objects:
            ...
            if self.inputs[(0, "slope_type")].GetCurrentSelection() != -1:
                tile.slope_type = slope_types[
                    self.inputs[(0, "slope_type")].GetCurrentSelection()
                ][0]
            if self.inputs[(0, "surface_type")].GetCurrentSelection() != -1:
                tile.surface_type = self.inputs[
                    (0, "surface_type")
                ].GetCurrentSelection()
...
class PaletteEditWindow(wx.Frame):
    def __init__(self, parent, ID, title):
        ...
        for y in range(16):
            ...
            for x in range(16):
                button = wx.Window(
                    panel, PALETTE_INPUT_ID + y * 16 + x, size=wx.Size(20, 20)
                )
        ...
        for i, color in enumerate(["R", "G", "B"]):
            ...
            color_slider = wx.Slider(
                panel, 5000 + i, 0, 0, max_value, size=wx.Size(290, -1)
            )
        ...
        self.alpha_checkbox = wx.CheckBox(
            panel, id=5003, label="Is Transparent if (r,g,b) is (0,0,0)"
        )
        ...
        sizer_sections.Add(
            sizer_sliders_preview, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        ...
        export_default_palette_button = wx.Button(
            panel, wx.ID_ANY, "Export Default palette"
        )
        ...
        sizer_sections.Add(
            bottom_row_buttons, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
    ...
    def on_color_slide(self, event):
        ...
        self.preview.SetBackgroundColour(
            wx.Colour(int(r * factor), int(g * factor), int(b * factor))
        )
        self.preview.Refresh()
    ...
    def export_palette(self, event):
        ...
        fileDialog = wx.FileDialog(
            ...
            wildcard="ACT Files (*.ACT)|*.ACT;*.act",
        )
        fileDialog.SetFilename(
            self.app.world.map.gns.file_path + ".palette_" + str(palette_id) + ".act"
        )
    ...
    def import_palette(self, event):
        ...
        fileDialog = wx.FileDialog(
            self, "Import Palette from ACT", wildcard="ACT Files (*.ACT)|*.ACT;*.act"
        )
        ...
        for index, color in enumerate(hex_list):
            ...
            if index % color_length == 0 and index < palette_length * color_length:
                ...
                self.set_button_id_color(
                    PALETTE_INPUT_ID + palette_id * 16 + color_id, r, g, b, a
                )
...
class LightsEditWindow(wx.Frame):
    def __init__(self, parent, ID, title):
        ...
        for i in range(3):
            ...
            elevation_slider = wx.Slider(
                panel, 7000 + i, 0, -90, 90, size=wx.Size(180, -1)
            )
            ...
            azimuth_slider = wx.Slider(
                panel, 7000 + i, 0, -180, 180, size=wx.Size(180, -1)
            )
            ...
            sizer_sections.Add(
                sizer_light, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
            )
        # Ambient light
        ...
        sizer_sections.Add(
            sizer_background, flag=wx.LEFT | wx.BOTTOM | wx.RIGHT, border=10
        )
        # Color sliders
    ...
    def from_data(self, dir_lights, amb_light, background):
        ...
        for i, light in enumerate(dir_lights):
            ...
            self.set_button_color(
                32768, self.color_buttons[("directional", i)], *light.color
            )
        ...
        self.set_button_color(
            255, self.color_buttons[("background", 0)], *background.color1
        )
        self.undo_data.append(background.color1)
        self.colors.append(background.color2)
        self.set_button_color(
            255, self.color_buttons[("background", 1)], *background.color2
        )
...
class Map_Viewer(DirectObject):
    ...
    def copy_polygon(self):
        texture = True
        if isinstance(self.selected_object, Polygon) or (
            len(self.selected_objects) > 0
            and isinstance(self.selected_objects[0], Polygon)
        ):
            if not len(self.selected_objects) == 0:
                ...
                if self.selected_object.source.unknown5 is not None:
                    texture = False
                self.world.copy_polygon_to_XOffset(
                    self.selected_object, 0 * 28, texture
                )
    ...
    def start(self, gns_path):
        ...
        self.multi_terrain_edit_window = MultiTerrainEditWindow(
            self, -1, "Edit Multiple Terrains"
        )
        self.terrain_dimensions_edit_window = TerrainDimensionsEditWindow(
            self, -1, "Edit Terrain Dimensions"
        )
        self.move_all_polygons_edit_window = MoveAllPolygonsEditWindow(
            self, -1, "Move All Polygons"
        )
        self.palette_edit_window = PaletteEditWindow(self, -1, "Edit Palettes")
        self.lights_edit_window = LightsEditWindow(
            self, -1, "Edit Lights and Background"
        )
    ...
    def edit_lights(self):
        self.lights_edit_window.from_data(
            self.world.dir_lights, self.world.amb_light, self.world.background
        )
